...
var _a, _RenderBillboards_createRenderShader;
...
export class RenderBillboards {
    static init() {
        ...
        const shaderModule = __classPrivateFieldGet(this, _a, "m", _RenderBillboards_createRenderShader).call(this);
...
_a = RenderBillboards, _RenderBillboards_createRenderShader = function _RenderBillboards_createRenderShader() {
